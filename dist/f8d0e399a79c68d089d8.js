    ...
    item.addEventListener("click", (e) => {
      ...
      for (let block of document.querySelectorAll("[data-item]")) {
        ...
        if (item.dataset.filter == "active") {
          ...
          $(".main__item-third").addClass(
            "animate__animated animate__fadeInDown animate__delay-.6s"
          );
          setTimeout(() => {
            $(".main__item-fougth").addClass(
              "animate__animated animate__fadeInDown animate__delay-.6s"
            );
...
window.addEventListener("scroll", () => {
  setTimeout(() => {
    if (pageYOffset >= 2300) {
      $(".company__intro-title").addClass(
        "animate__animated animate__fadeInDown animate__delay-.6s"
      );
      $(".company__intro-title").css("opacity", "1");
    }
    if (pageYOffset <= 2200) {
      $(".company__intro-title").removeClass(
        "animate__animated animate__fadeInDown animate__delay-.6s"
      );
  ...
  if (pageYOffset >= 630) {
    $(".main__item-first").addClass(
      "animate__animated animate__fadeInLeft animate__delay-.6s"
    );
    $(".main__item-first").css("opacity", "1");
    setTimeout(() => {
      $(".main__item-second").addClass(
  ...
  if (pageYOffset <= 320) {
    $(".main__item-first").removeClass(
      "animate__animated animate__fadeInLeft animate__delay-.6s"
    );
    $(".main__item-second").removeClass(
      "animate__animated animate__fadeInRight animate__delay-.6s"
    );
  ...
  if (pageYOffset <= 320) {
    $(".main__item-third").removeClass(
      "animate__animated animate__fadeInDown animate__delay-.6s"
    );
    $(".main__item-fougth").removeClass(
      "animate__animated animate__fadeInDown animate__delay-.6s"
    );
